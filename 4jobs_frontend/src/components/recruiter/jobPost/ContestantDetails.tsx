...
import {
  fetchContestantDetailsAsync,
  clearSelectedContestant,
...
const ContestantDetails: React.FC = () => {
  ...
  const { selectedContestant, loading, error } = useSelector(
  ...
  const handleStartConversation = async () => {
    try {
      await startConversationApi(
        selectedContestant?.id ? selectedContestant?.id : "",
        recruiterId
      );
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-extrabold mb-8 text-purple-900 border-b-2 border-purple-200 pb-2">
            Applicant Profile
          </h2>
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-8">
              ...
              {selectedContestant.skills &&
                selectedContestant.skills.length > 0 && (
                  <div className="mb-8">
                    <h4 className="text-xl font-semibold text-purple-900 mb-3">
                      Skills
                    </h4>
                    <div className="flex flex-wrap">
                      {selectedContestant.skills.map((skill, index) => (
                        <span
                          key={index}
                          className="bg-purple-100 text-purple-800 rounded-full px-4 py-2 text-sm font-medium mr-2 mb-2 shadow-sm"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              {selectedContestant.experiences &&
                selectedContestant.experiences.length > 0 && (
                  <div className="mb-8">
                    <h4 className="text-xl font-semibold text-purple-900 mb-3">
              ...
              {selectedContestant.projects &&
                selectedContestant.projects.length > 0 && (
                  <div className="mb-8">
                    <h4 className="text-xl font-semibold text-purple-900 mb-3">
                      Projects
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {selectedContestant.projects.map((project) => (
                        ...
                        >
                          ...
                          <div className="p-6">
                            <p className="font-semibold text-lg text-purple-900 mb-2">
                              {project.name}
                            </p>
              ...
              {selectedContestant.certificates &&
                selectedContestant.certificates.length > 0 && (
                  <div className="mb-8">
                    <h4 className="text-xl font-semibold text-purple-900 mb-3">
                      Certifications
                    </h4>
