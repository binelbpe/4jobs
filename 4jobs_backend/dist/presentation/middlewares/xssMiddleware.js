...
exports.createXssMiddleware = exports.XssMiddleware = void 0;
const inversify_1 = require("inversify");
const types_1 = __importDefault(require("../../types"));
let XssMiddleware = class XssMiddleware {
    constructor(xssService) {
...
exports.XssMiddleware = XssMiddleware = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.default.XssService)),
    __metadata("design:paramtypes", [Object])
], XssMiddleware);
// Create a factory function to get middleware instance
const createXssMiddleware = (container) => {
    const xssMiddleware = container.get(XssMiddleware);
    return xssMiddleware.handle;
};
exports.createXssMiddleware = createXssMiddleware;
