  ...
  const validateForm = () => {
    ...
    if (!formData.governmentId) {
      ...
      if (!validFileTypes.includes(formData.governmentId.type)) {
        errors.governmentId = 'Please upload a valid file (JPEG, PNG, PDF, WEBP).';
    ...
    return !errors.name && !errors.companyName && !errors.email && !errors.phone && !errors.password && !errors.governmentId;
  };
      ...
      <div className="w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-xl">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="p-12 md:w-3/5">
            <h2 className="mb-6 text-3xl font-semibold text-purple-600">Recruiter Registration</h2>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                {formErrors.governmentId && <p className="mt-1 text-xs text-red-500">{formErrors.governmentId}</p>}
              </div>
              <button
                type="submit"
                disabled={loading}
