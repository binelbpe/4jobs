  ...
  return (
    <div className="min-h-screen bg-gray-100 connection-profile">
      <div className="container mx-auto px-4 py-8">
        <button
          onClick={handleClose}
          className="mb-4 flex items-center text-purple-700 hover:text-purple-900"
        >
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            {connectionProfile.skills &&
              connectionProfile.skills.length > 0 && (
                <div className="mb-8">
                  <h2 className="text-2xl font-semibold mb-4 text-purple-700">
                    Skills
                  </h2>
            ...
            {connectionProfile.experiences &&
              connectionProfile.experiences.length > 0 && (
                <div className="mb-8">
                  <h2 className="text-2xl font-semibold mb-4 text-purple-700">
                    Experiences
                  </h2>
