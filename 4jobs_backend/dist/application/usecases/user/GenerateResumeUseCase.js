...
exports.GenerateResumeUseCase = void 0;
const inversify_1 = require("inversify");
const types_1 = __importDefault(require("../../../types"));
const PDFGeneratorService_1 = require("../../../infrastructure/services/PDFGeneratorService");
let GenerateResumeUseCase = class GenerateResumeUseCase {
...
exports.GenerateResumeUseCase = GenerateResumeUseCase;
exports.GenerateResumeUseCase = GenerateResumeUseCase = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.default.IResumeRepository)),
