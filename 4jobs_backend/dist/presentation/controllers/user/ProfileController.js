...
let ProfileController = class ProfileController {
    ...
    updateUserProjects(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const updatedUser = yield this.userRepository.update(userId, { projects });
                if (!updatedUser) {
                    return res.status(404).json({ message: 'User not found' });
                }
                res.json(updatedUser);
    ...
    updateUserExperiences(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const updatedUser = yield this.userRepository.update(userId, { experiences });
                if (!updatedUser) {
                    return res.status(404).json({ message: 'User not found' });
                }
                res.json(updatedUser);
    ...
    updateUserResume(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const updatedUser = yield this.userRepository.update(userId, { resume });
                if (!updatedUser) {
                    return res.status(404).json({ message: 'User not found' });
                }
                res.json(updatedUser);
