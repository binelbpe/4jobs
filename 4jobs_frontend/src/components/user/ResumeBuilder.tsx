...
const ResumeBuilder: React.FC = () => {
  ...
  const userId = useSelector((state: RootState) => state.auth.user?.id); // Get userId from auth state
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-3xl font-bold text-purple-700 mb-6">Resume Builder</h1>
          ...
          {formData.projects.map((project, index) => (
            <div key={index} className="mb-4 p-4 border border-purple-200 rounded-md relative">
              <input
                ...
                className="mb-2 w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
              />
              <textarea
