...
let RecruiterMessageUseCase = class RecruiterMessageUseCase {
    ...
    sendMessage(conversationId, content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = new RecruiterMessage_1.RecruiterMessage('', conversationId, conversation.recruiterId, // Use the recruiterId from the conversation
            conversation.applicantId, 'recruiter', content, new Date());
