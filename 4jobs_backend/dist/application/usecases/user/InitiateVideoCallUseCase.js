...
let InitiateVideoCallUseCase = class InitiateVideoCallUseCase {
    ...
    execute(callerId, recipientId) {
        return __awaiter(this, void 0, void 0, function* () {
            const existingCall = yield this.videoCallRepository.findPendingCallForUser(callerId);
            if (existingCall) {
                throw new Error('User already has a pending call');
            }
            const newVideoCall = new VideoCall_1.VideoCall('', callerId, recipientId, 'pending', new Date(), new Date());
