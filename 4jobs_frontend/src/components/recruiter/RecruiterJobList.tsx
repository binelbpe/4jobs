...
const JobList: React.FC<JobListProps> = ({ jobs }) => {
  return (
    <div className="space-y-6">
      {jobs.map((job) => (
        <div key={job._id} className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-300 border-l-4 border-purple-600">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            {job.skillsRequired.length > 5 && (
              <span className="text-purple-500 text-xs">+{job.skillsRequired.length - 5} more</span>
            )}
          </div>
